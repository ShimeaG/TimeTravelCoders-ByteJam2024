  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <input type="textarea" id="eventTitle" value={eventTitle} onChange={(e) => setEventTitle(e.target.value)} />
      </div>
      <div>
      ...
      <div>
        ...
        <input type="textarea" id="eventImage" value={eventImage} onChange={(e) => setEventImage(e.target.value)} />
      </div>
